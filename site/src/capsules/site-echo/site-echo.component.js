...
const module0 = getCoreModule('site-echo.component.core.wasm');
const module1 = getCoreModule('site-echo.component.core2.wasm');
const module2 = getCoreModule('site-echo.component.core3.wasm');
