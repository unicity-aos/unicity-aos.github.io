...
export function instantiate(getCoreModule, imports, instantiateCore = WebAssembly.instantiate) {
  ...
  function _lowerImportBackwardsCompat(args) {
    ...
    const module0 = getCoreModule('site-guard.component.core.wasm');
    const module1 = getCoreModule('site-guard.component.core2.wasm');
    const module2 = getCoreModule('site-guard.component.core3.wasm');
    ...
    let gen = (function* _initGenerator () {
      ...
      const _trampoline0 = function(arg0, arg1, arg2, arg3, arg4) {
        var ptr0 = arg0;
        var len0 = arg1;
    ...
    _trampoline0.fnName = 'astrid:ipc/host@1.0.0#publish';
    ...
    _trampoline1.fnName = 'astrid:sys/host@1.0.0#log';
  ...
  _trampoline2.fnName = 'astrid:sys/host@1.0.0#randomBytes';
  let exports2;
  let postReturn0;
