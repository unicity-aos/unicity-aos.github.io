...
const module0 = getCoreModule('site-pulse.component.core.wasm');
const module1 = getCoreModule('site-pulse.component.core2.wasm');
const module2 = getCoreModule('site-pulse.component.core3.wasm');
...
const { kvGet, kvSet } = imports['astrid:kv/host'];
...
const { log, randomBytes } = imports['astrid:sys/host'];
...
let gen = (function* _initGenerator () {
  ...
  _trampoline0.fnName = 'astrid:sys/host@1.0.0#log';
...
_trampoline1.fnName = 'astrid:sys/host@1.0.0#randomBytes';
...
_trampoline2.fnName = 'astrid:kv/host@1.0.0#kvGet';
...
_trampoline3.fnName = 'astrid:kv/host@1.0.0#kvSet';
...
_trampoline4.fnName = 'astrid:ipc/host@1.0.0#publish';
let exports2;
let postReturn0;
