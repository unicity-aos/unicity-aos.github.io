...
const module0 = getCoreModule('openai-compat.component.core.wasm');
const module1 = getCoreModule('openai-compat.component.core2.wasm');
const module2 = getCoreModule('openai-compat.component.core3.wasm');

const { HttpStream, httpRequest, httpStreamStart } = imports['astrid:http/host'];

if (HttpStream=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'HttpStream', was 'HttpStream' available at instantiation?");
...
if (httpRequest=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'httpRequest', was 'httpRequest' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}


if (httpStreamStart=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'httpStreamStart', was 'httpStreamStart' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { publish } = imports['astrid:ipc/host'];

if (publish=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'publish', was 'publish' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { getConfig, log, randomBytes } = imports['astrid:sys/host'];

if (getConfig=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'getConfig', was 'getConfig' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (log=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'log', was 'log' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (randomBytes=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'randomBytes', was 'randomBytes' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
let gen = (function* _initGenerator () {
  ...
  const _trampoline0 = function(arg0) {
    ...
    if (!rsc0) {
      rsc0 = Object.create(HttpStream.prototype);
      Object.defineProperty(rsc0, symbolRscHandle, { writable: true, value: handle1});
      Object.defineProperty(rsc0, symbolRscRep, { writable: true, value: rep2});
    }
    
    curResourceBorrows.push(rsc0);
    _debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.status"] [Instruction::CallInterface] (sync, @ enter)');
    ...
    curResourceBorrows = [];
    _debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.status"][Instruction::Return]', {
      funcName: '[method]http-stream.status',
      paramCount: 1,
      async: false,
      postReturn: false
    });
  ...
  _trampoline0.fnName = 'astrid:http/host@1.0.0#status';
  let exports1;
  let memory0;
  let realloc0;
  let realloc0Async;
  ...
  const _trampoline2 = function(arg0, arg1, arg2) {
    ...
    switch (arg0) {
      ...
      default: {
        throw new TypeError('invalid discriminant specified for LogLevel');
      }
    }
    var ptr1 = arg1;
    var len1 = arg2;
    var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
    _debugLog('[iface="astrid:sys/host@1.0.0", function="log"] [Instruction::CallInterface] (sync, @ enter)');
    const hostProvided = true;
    ...
    _debugLog('[iface="astrid:sys/host@1.0.0", function="log"][Instruction::Return]', {
      funcName: 'log',
      paramCount: 0,
      async: false,
      postReturn: false
  ...
  _trampoline2.fnName = 'astrid:sys/host@1.0.0#log';
  
  const _trampoline3 = function(arg0, arg1, arg2) {
    var ptr0 = arg0;
    var len0 = arg1;
    var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
    _debugLog('[iface="astrid:sys/host@1.0.0", function="get-config"] [Instruction::CallInterface] (sync, @ enter)');
    const hostProvided = true;
  ...
  switch (variant5.tag) {
    ...
    case 'err': {
      ...
      switch (variant4.tag) {
        ...
        default: {
          throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant4.tag)}\` (received \`${variant4}\`) specified for \`ErrorCode\``);
        }
      }
  ...
  _debugLog('[iface="astrid:sys/host@1.0.0", function="get-config"][Instruction::Return]', {
    funcName: 'get-config',
    paramCount: 0,
    async: false,
    postReturn: false
...
_trampoline3.fnName = 'astrid:sys/host@1.0.0#getConfig';

const _trampoline4 = function(arg0, arg1) {
  _debugLog('[iface="astrid:sys/host@1.0.0", function="random-bytes"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => randomBytes(BigInt.asUintN(64, BigInt(arg0))),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
switch (variant3.tag) {
  ...
  case 'err': {
    ...
    switch (variant2.tag) {
      ...
      case 'registry-unavailable': {
        dataView(memory0).setInt8(arg1 + 4, 3, true);
        break;
      }
      case 'cancelled': {
        dataView(memory0).setInt8(arg1 + 4, 4, true);
        break;
      }
      case 'unknown': {
        const e = variant2.val;
        dataView(memory0).setInt8(arg1 + 4, 5, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr1= encodeRes.ptr;
        var len1 = encodeRes.len;
        
        dataView(memory0).setUint32(arg1 + 12, len1, true);
        dataView(memory0).setUint32(arg1 + 8, ptr1, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant2.tag)}\` (received \`${variant2}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:sys/host@1.0.0", function="random-bytes"][Instruction::Return]', {
  funcName: 'random-bytes',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline4.fnName = 'astrid:sys/host@1.0.0#randomBytes';

const _trampoline5 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let variant2;
  switch (arg2) {
    ...
    default: {
      throw new TypeError('invalid variant discriminant for HttpMethod');
    }
  }
  var len5 = arg6;
  var base5 = arg5;
  ...
  _debugLog('[iface="astrid:http/host@1.0.0", function="http-stream-start"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant12.tag) {
  case 'ok': {
    ...
    if (!(e instanceof HttpStream)) {
      throw new TypeError('Resource error: Not a valid \"HttpStream\" resource.');
    }
    var handle8 = e[symbolRscHandle];
    if (!handle8) {
      const rep = e[symbolRscRep] || ++captureCnt0;
      captureTable0.set(rep, e);
      handle8 = rscTableCreateOwn(handleTable0, rep);
    }
    
    dataView(memory0).setInt32(arg10 + 4, handle8, true);
  ...
  case 'err': {
    ...
    switch (variant11.tag) {
      ...
      case 'airlock-rejected': {
        dataView(memory0).setInt8(arg10 + 4, 3, true);
        break;
      }
      case 'tls-error': {
        dataView(memory0).setInt8(arg10 + 4, 4, true);
        break;
      }
      case 'timeout': {
        dataView(memory0).setInt8(arg10 + 4, 5, true);
        break;
      }
      case 'connection-error': {
        dataView(memory0).setInt8(arg10 + 4, 6, true);
        break;
      }
      case 'body-too-large': {
        dataView(memory0).setInt8(arg10 + 4, 7, true);
        break;
      }
      case 'closed': {
        dataView(memory0).setInt8(arg10 + 4, 8, true);
        break;
      }
      case 'quota': {
        dataView(memory0).setInt8(arg10 + 4, 9, true);
        break;
      }
      case 'protocol': {
        const e = variant11.val;
        dataView(memory0).setInt8(arg10 + 4, 10, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr9= encodeRes.ptr;
        var len9 = encodeRes.len;
        
        dataView(memory0).setUint32(arg10 + 12, len9, true);
        dataView(memory0).setUint32(arg10 + 8, ptr9, true);
        break;
      }
      case 'unknown': {
        const e = variant11.val;
        dataView(memory0).setInt8(arg10 + 4, 11, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr10= encodeRes.ptr;
        var len10 = encodeRes.len;
        
        dataView(memory0).setUint32(arg10 + 12, len10, true);
        dataView(memory0).setUint32(arg10 + 8, ptr10, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant11.tag)}\` (received \`${variant11}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:http/host@1.0.0", function="http-stream-start"][Instruction::Return]', {
  funcName: 'http-stream-start',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline5.fnName = 'astrid:http/host@1.0.0#httpStreamStart';
...
const _trampoline6 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.headers"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  for (let i = 0; i < vec6.length; i++) {
    const e = vec6[i];
    const base = result6 + i * 16;var {key: v3_0, value: v3_1 } = e;
  ...
  _debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.headers"][Instruction::Return]', {
    funcName: '[method]http-stream.headers',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
_trampoline6.fnName = 'astrid:http/host@1.0.0#headers';

const _trampoline7 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let variant2;
  ...
  _debugLog('[iface="astrid:http/host@1.0.0", function="http-request"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant17.tag) {
  case 'ok': {
    ...
    dataView(memory0).setInt8(arg10 + 0, 0, true);
    var {status: v8_0, headers: v8_1, body: v8_2 } = e;
    ...
    for (let i = 0; i < vec12.length; i++) {
      const e = vec12[i];
      const base = result12 + i * 16;var {key: v9_0, value: v9_1 } = e;
    ...
    dataView(memory0).setUint32(arg10 + 12, len12, true);
    dataView(memory0).setUint32(arg10 + 8, result12, true);
    var val13 = v8_2;
    var len13 = Array.isArray(val13) ? val13.length : val13.byteLength;
    var ptr13 = realloc0(0, 0, 1, len13 * 1);
    
    let valData13;
    const valLenBytes13 = len13 * 1;
    if (Array.isArray(val13)) {
      ...
      for (const v of val13) {
        _requireValidNumericPrimitive.bind(null, 'u8')(v);
        dv13.setUint8(ptr13+ offset, v, true);
        offset += 1;
      }
    } else {
      // TypedArray / ArrayBuffer-like, direct copy
    ...
    dataView(memory0).setUint32(arg10 + 20, len13, true);
    dataView(memory0).setUint32(arg10 + 16, ptr13, true);
  ...
  case 'err': {
    ...
    switch (variant16.tag) {
      ...
      case 'protocol': {
        ...
        dataView(memory0).setUint32(arg10 + 12, len14, true);
        dataView(memory0).setUint32(arg10 + 8, ptr14, true);
        break;
      }
      case 'unknown': {
        const e = variant16.val;
        ...
        dataView(memory0).setUint32(arg10 + 12, len15, true);
        dataView(memory0).setUint32(arg10 + 8, ptr15, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant16.tag)}\` (received \`${variant16}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:http/host@1.0.0", function="http-request"][Instruction::Return]', {
  funcName: 'http-request',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline7.fnName = 'astrid:http/host@1.0.0#httpRequest';
...
const _trampoline8 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.read-chunk"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant7.tag) {
  ...
  case 'err': {
    ...
    switch (variant6.tag) {
      ...
      case 'connection-error': {
        dataView(memory0).setInt8(arg1 + 4, 6, true);
        break;
      }
      case 'body-too-large': {
        dataView(memory0).setInt8(arg1 + 4, 7, true);
        break;
      }
      case 'closed': {
        dataView(memory0).setInt8(arg1 + 4, 8, true);
        break;
      }
      case 'quota': {
        dataView(memory0).setInt8(arg1 + 4, 9, true);
        break;
      }
      case 'protocol': {
        const e = variant6.val;
        dataView(memory0).setInt8(arg1 + 4, 10, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr4= encodeRes.ptr;
        var len4 = encodeRes.len;
        
        dataView(memory0).setUint32(arg1 + 12, len4, true);
        dataView(memory0).setUint32(arg1 + 8, ptr4, true);
        break;
      }
      case 'unknown': {
        const e = variant6.val;
        dataView(memory0).setInt8(arg1 + 4, 11, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr5= encodeRes.ptr;
        var len5 = encodeRes.len;
        
        dataView(memory0).setUint32(arg1 + 12, len5, true);
        dataView(memory0).setUint32(arg1 + 8, ptr5, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant6.tag)}\` (received \`${variant6}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:http/host@1.0.0", function="[method]http-stream.read-chunk"][Instruction::Return]', {
  funcName: '[method]http-stream.read-chunk',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline8.fnName = 'astrid:http/host@1.0.0#readChunk';

const _trampoline9 = function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
  var len1 = arg3;
  var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="astrid:ipc/host@1.0.0", function="publish"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant4.tag) {
  ...
  case 'err': {
    ...
    switch (variant3.tag) {
      ...
      case 'closed': {
        dataView(memory0).setInt8(arg4 + 4, 2, true);
        break;
      }
      case 'rate-limited': {
        dataView(memory0).setInt8(arg4 + 4, 3, true);
        break;
      }
      case 'backpressure': {
        dataView(memory0).setInt8(arg4 + 4, 4, true);
        break;
      }
      case 'quota': {
        dataView(memory0).setInt8(arg4 + 4, 5, true);
        break;
      }
      case 'timeout': {
        dataView(memory0).setInt8(arg4 + 4, 6, true);
        break;
      }
      case 'unknown': {
        const e = variant3.val;
        dataView(memory0).setInt8(arg4 + 4, 7, true);
      ...
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant3.tag)}\` (received \`${variant3}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:ipc/host@1.0.0", function="publish"][Instruction::Return]', {
  funcName: 'publish',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline9.fnName = 'astrid:ipc/host@1.0.0#publish';
let exports2;
let postReturn0;
let postReturn0Async;
let exports1AstridHookTrigger;

function astridHookTrigger(arg0, arg1) {
  ...
  _debugLog('[iface="astrid-hook-trigger", function="astrid-hook-trigger"][Instruction::CallWasm] enter', {
    funcName: 'astrid-hook-trigger',
    paramCount: 4,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'exports1AstridHookTrigger',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1AstridHookTrigger(ptr0, len0, ptr1, len1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="astrid-hook-trigger", function="astrid-hook-trigger"][Instruction::Return]', {
    funcName: 'astrid-hook-trigger',
    paramCount: 1,
    async: false,
    postReturn: true
...
function run() {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'exports1AstridInstall',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
...
function astridInstall() {
  _debugLog('[iface="astrid-install", function="astrid-install"][Instruction::CallWasm] enter', {
    funcName: 'astrid-install',
    paramCount: 0,
    async: false,
    postReturn: false,
  });
  ...
  _debugLog('[iface="astrid-install", function="astrid-install"][Instruction::Return]', {
    funcName: 'astrid-install',
    paramCount: 0,
    async: false,
    postReturn: false
...
function astridUpgrade() {
  _debugLog('[iface="astrid-upgrade", function="astrid-upgrade"][Instruction::CallWasm] enter', {
    funcName: 'astrid-upgrade',
    paramCount: 0,
    async: false,
    postReturn: false,
  });
  ...
  _debugLog('[iface="astrid-upgrade", function="astrid-upgrade"][Instruction::Return]', {
    funcName: 'astrid-upgrade',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline1(handle) {
  ...
  if (handleEntry.own) {
    ...
    } else if (HttpStream[symbolCabiDispose]) {
      HttpStream[symbolCabiDispose](handleEntry.rep);
    }
  }
}
...
null,
{
  ...
  paramLiftFns: [
  _liftFlatEnum({
    caseMetas: [['trace', null, 1, 1, 1],['debug', null, 1, 1, 1],['info', null, 1, 1, 1],['warn', null, 1, 1, 1],['error', null, 1, 1, 1],],
    variantSize32: 1,
    variantAlign32: 1,
...
null,
{
  ...
  _lowerFlatResult({
    ...
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'capability-denied', null, 0, 0, 0 ],[ 'config-key-reserved', null, 0, 0, 0 ],[ 'too-large', null, 0, 0, 0 ],[ 'registry-unavailable', null, 0, 0, 0 ],[ 'cancelled', null, 0, 0, 0 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
null,
{
  ...
  paramLiftFns: [_liftFlatRecord({ fieldMetas: [['url', _liftFlatStringAny, 8, 4],['method', _liftFlatVariant({
    ...
    variantPayloadOffset32: 4,
    variantFlatCount: 3,
  } ), 12, 4],['headers', _liftFlatList({
    elemLiftFn: _liftFlatRecord({ fieldMetas: [['key', _liftFlatStringAny, 8, 4],['value', _liftFlatStringAny, 8, 4],], size32: 16, align32: 4 }),
    elemAlign32: 4,
    elemSize32: 16,
    typedArray: undefined,
  }), 8, 4],['body', 
  ...
  _lowerFlatResult({
    ...
    [ 'ok', _lowerFlatOwn({
      componentIdx: 0,
      lowerFn: 
      function lowerImportedOwnedHost_HttpStream(obj) {
        if (!(obj instanceof HttpStream)) {
          throw new TypeError('Resource error: Not a valid \"HttpStream\" resource.');
        }
    ...
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'capability-denied', null, 0, 0, 0 ],[ 'invalid-request', null, 0, 0, 0 ],[ 'dns-error', null, 0, 0, 0 ],[ 'airlock-rejected', null, 0, 0, 0 ],[ 'tls-error', null, 0, 0, 0 ],[ 'timeout', null, 0, 0, 0 ],[ 'connection-error', null, 0, 0, 0 ],[ 'body-too-large', null, 0, 0, 0 ],[ 'closed', null, 0, 0, 0 ],[ 'quota', null, 0, 0, 0 ],[ 'protocol', _lowerFlatStringAny, 8, 4, 2 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
null,
{
  ...
  resultLowerFns: [_lowerFlatList({
    elemLowerFn: _lowerFlatRecord({ fieldMetas: [['key', _lowerFlatStringAny, 8, 4 ],['value', _lowerFlatStringAny, 8, 4 ],], size32: 16, align32: 4 }),
    elemSize32: 16,
    elemAlign32: 4,
  })],
  hasResultPointer: true,
...
null,
{
  ...
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatRecord({ fieldMetas: [['status', _lowerFlatU16, 2, 2 ],['headers', _lowerFlatList({
      elemLowerFn: _lowerFlatRecord({ fieldMetas: [['key', _lowerFlatStringAny, 8, 4 ],['value', _lowerFlatStringAny, 8, 4 ],], size32: 16, align32: 4 }),
      elemSize32: 16,
      elemAlign32: 4,
    }), 8, 4 ],['body', _lowerFlatList({
      elemLowerFn: _lowerFlatU8,
      elemSize32: 1,
      elemAlign32: 1,
...
null,
{
  ...
  _lowerFlatResult({
    ...
    [ 'ok', null, 16, 4, 4 ],
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'capability-denied', null, 0, 0, 0 ],[ 'invalid-input', null, 0, 0, 0 ],[ 'closed', null, 0, 0, 0 ],[ 'rate-limited', null, 0, 0, 0 ],[ 'backpressure', null, 0, 0, 0 ],[ 'quota', null, 0, 0, 0 ],[ 'timeout', null, 0, 0, 0 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
({ exports: exports1 } = yield instantiateCore(yield module0, {
  'astrid:http/host@1.0.0': {
    '[method]http-stream.headers': exports0['4'],
    '[method]http-stream.read-chunk': exports0['6'],
    '[method]http-stream.status': trampoline0,
    '[resource-drop]http-stream': trampoline1,
    'http-request': exports0['5'],
    'http-stream-start': exports0['3'],
  },
  'astrid:ipc/host@1.0.0': {
    publish: exports0['7'],
  },
  'astrid:sys/host@1.0.0': {
    'get-config': exports0['1'],
    log: exports0['0'],
    'random-bytes': exports0['2'],
  },
}));
...
postReturn0 = exports1['cabi_post_astrid-hook-trigger'];

try {
  postReturn0Async = WebAssembly.promising(exports1['cabi_post_astrid-hook-trigger']);
} catch(err) {
  postReturn0Async = exports1['cabi_post_astrid-hook-trigger'];
}

exports1AstridHookTrigger = exports1['astrid-hook-trigger'];
exports1AstridInstall = exports1['astrid-install'];

return { astridHookTrigger, astridInstall, astridUpgrade, run,  };
})();
