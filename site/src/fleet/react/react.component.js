...
const module0 = getCoreModule('react.component.core.wasm');
const module1 = getCoreModule('react.component.core2.wasm');
const module2 = getCoreModule('react.component.core3.wasm');

const { Subscription, publish, subscribe } = imports['astrid:ipc/host'];

if (Subscription=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'Subscription', was 'Subscription' available at instantiation?");
...
if (subscribe=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'subscribe', was 'subscribe' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { kvClearPrefix, kvDelete, kvGet, kvSet } = imports['astrid:kv/host'];

if (kvClearPrefix=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvClearPrefix', was 'kvClearPrefix' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}


if (kvDelete=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvDelete', was 'kvDelete' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (kvGet=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvGet', was 'kvGet' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (kvSet=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvSet', was 'kvSet' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { clockMs, getConfig, log, randomBytes } = imports['astrid:sys/host'];

if (clockMs=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'clockMs', was 'clockMs' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
let gen = (function* _initGenerator () {
  ...
  const _trampoline0 = function() {
    _debugLog('[iface="astrid:sys/host@1.0.0", function="clock-ms"] [Instruction::CallInterface] (sync, @ enter)');
    ...
    _debugLog('[iface="astrid:sys/host@1.0.0", function="clock-ms"][Instruction::Return]', {
      funcName: 'clock-ms',
      paramCount: 1,
      async: false,
      postReturn: false
  ...
  _trampoline0.fnName = 'astrid:sys/host@1.0.0#clockMs';
  let exports1;
  let memory0;
  let realloc0;
  let realloc0Async;
...
const _trampoline5 = function(arg0, arg1, arg2) {
  ...
  if (!rsc0) {
    rsc0 = Object.create(Subscription.prototype);
    Object.defineProperty(rsc0, symbolRscHandle, { writable: true, value: handle1});
    Object.defineProperty(rsc0, symbolRscRep, { writable: true, value: rep2});
  }
  
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="astrid:ipc/host@1.0.0", function="[method]subscription.recv"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => rsc0.recv(BigInt.asUintN(64, BigInt(arg1))),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
switch (variant14.tag) {
  case 'ok': {
    ...
    dataView(memory0).setInt8(arg2 + 0, 0, true);
    var {messages: v3_0, dropped: v3_1, lagged: v3_2 } = e;
    var vec11 = v3_0;
    var len11 = vec11.length;
    var result11 = realloc0(0, 0, 4, len11 * 36);
    for (let i = 0; i < vec11.length; i++) {
      const e = vec11[i];
      const base = result11 + i * 36;var {topic: v4_0, payload: v4_1, sourceId: v4_2, principal: v4_3 } = e;
      ...
      var encodeRes = _utf8AllocateAndEncode(v4_2, realloc0, memory0);
      ...
      switch (variant10.tag) {
        case 'verified': {
          ...
          dataView(memory0).setUint32(base + 32, len8, true);
          dataView(memory0).setUint32(base + 28, ptr8, true);
          break;
        }
        case 'claimed': {
          const e = variant10.val;
          ...
          dataView(memory0).setUint32(base + 32, len9, true);
          dataView(memory0).setUint32(base + 28, ptr9, true);
          break;
        }
        case 'system': {
          dataView(memory0).setInt8(base + 24, 2, true);
          break;
        }
        default: {
          throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant10.tag)}\` (received \`${variant10}\`) specified for \`PrincipalAttribution\``);
        }
      }
    }
    dataView(memory0).setUint32(arg2 + 12, len11, true);
    dataView(memory0).setUint32(arg2 + 8, result11, true);
    dataView(memory0).setBigInt64(arg2 + 16, toUint64(v3_1), true);
    dataView(memory0).setBigInt64(arg2 + 24, toUint64(v3_2), true);
  ...
  case 'err': {
    ...
    switch (variant13.tag) {
      ...
      case 'unknown': {
        ...
        dataView(memory0).setInt8(arg2 + 8, 7, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr12= encodeRes.ptr;
        var len12 = encodeRes.len;
        
        dataView(memory0).setUint32(arg2 + 16, len12, true);
        dataView(memory0).setUint32(arg2 + 12, ptr12, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant13.tag)}\` (received \`${variant13}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:ipc/host@1.0.0", function="[method]subscription.recv"][Instruction::Return]', {
  funcName: '[method]subscription.recv',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline5.fnName = 'astrid:ipc/host@1.0.0#recv';
...
_trampoline6.fnName = 'astrid:ipc/host@1.0.0#publish';

const _trampoline7 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="astrid:ipc/host@1.0.0", function="subscribe"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant4.tag) {
  case 'ok': {
    ...
    if (!(e instanceof Subscription)) {
      throw new TypeError('Resource error: Not a valid \"Subscription\" resource.');
    }
  ...
  case 'err': {
    ...
    switch (variant3.tag) {
      ...
      case 'unknown': {
        const e = variant3.val;
        dataView(memory0).setInt8(arg2 + 4, 7, true);
...
_debugLog('[iface="astrid:ipc/host@1.0.0", function="subscribe"][Instruction::Return]', {
  funcName: 'subscribe',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline7.fnName = 'astrid:ipc/host@1.0.0#subscribe';

const _trampoline8 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-clear-prefix"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-clear-prefix"][Instruction::Return]', {
  funcName: 'kv-clear-prefix',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline8.fnName = 'astrid:kv/host@1.0.0#kvClearPrefix';

const _trampoline9 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-get"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-get"][Instruction::Return]', {
  funcName: 'kv-get',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline9.fnName = 'astrid:kv/host@1.0.0#kvGet';

const _trampoline10 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-delete"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-delete"][Instruction::Return]', {
  funcName: 'kv-delete',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline10.fnName = 'astrid:kv/host@1.0.0#kvDelete';
...
const _trampoline11 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-set"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-set"][Instruction::Return]', {
  funcName: 'kv-set',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline11.fnName = 'astrid:kv/host@1.0.0#kvSet';
let exports2;
let postReturn0;
...
function trampoline1(handle) {
  ...
  if (handleEntry.own) {
    ...
    } else if (Subscription[symbolCabiDispose]) {
      Subscription[symbolCabiDispose](handleEntry.rep);
    }
  }
}
...
null,
{
  ...
  paramLiftFns: [_liftFlatBorrow.bind(null, 0),_liftFlatU64],
  resultLowerFns: [
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatRecord({ fieldMetas: [['messages', _lowerFlatList({
      elemLowerFn: _lowerFlatRecord({ fieldMetas: [['topic', _lowerFlatStringAny, 8, 4 ],['payload', _lowerFlatStringAny, 8, 4 ],['sourceId', _lowerFlatStringAny, 8, 4 ],['principal', _lowerFlatVariant({
        caseMetas: [[ 'verified', _lowerFlatStringAny, 8, 4, 2 ],[ 'claimed', _lowerFlatStringAny, 8, 4, 2 ],[ 'system', null, 0, 0, 0 ],],
        variantSize32: 12,
        variantAlign32: 4,
        variantPayloadOffset32: 4,
        variantFlatCount: 3,
      ...
      elemSize32: 36,
      elemAlign32: 4,
    }), 8, 4 ],['dropped', _lowerFlatU64, 8, 8 ],['lagged', _lowerFlatU64, 8, 8 ],], size32: 24, align32: 8 }), 32, 8, 8 ],
    [ 'err', _lowerFlatVariant({
...
null,
{
  ...
  _lowerFlatResult({
    ...
    [ 'ok', _lowerFlatOwn({
      componentIdx: 0,
      lowerFn: 
      function lowerImportedOwnedHost_Subscription(obj) {
...
null,
{
  ...
  _lowerFlatResult({
    ...
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'invalid-key', null, 0, 0, 0 ],[ 'too-large', null, 0, 0, 0 ],[ 'quota', null, 0, 0, 0 ],[ 'cas-mismatch', null, 0, 0, 0 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
      variantPayloadOffset32: 4,
      variantFlatCount: 3,
...
({ exports: exports1 } = yield instantiateCore(yield module0, {
  'astrid:ipc/host@1.0.0': {
    '[method]subscription.recv': exports0['3'],
    '[resource-drop]subscription': trampoline1,
    publish: exports0['4'],
    subscribe: exports0['5'],
  },
  'astrid:kv/host@1.0.0': {
    'kv-clear-prefix': exports0['6'],
    'kv-delete': exports0['8'],
    'kv-get': exports0['7'],
    'kv-set': exports0['9'],
  },
  'astrid:sys/host@1.0.0': {
    'clock-ms': trampoline0,
