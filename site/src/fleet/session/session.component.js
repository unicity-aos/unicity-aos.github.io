...
const module0 = getCoreModule('session.component.core.wasm');
const module1 = getCoreModule('session.component.core2.wasm');
const module2 = getCoreModule('session.component.core3.wasm');
...
const { kvCas, kvDelete, kvGet, kvListKeys, kvListKeysPage } = imports['astrid:kv/host'];

if (kvCas=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvCas', was 'kvCas' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}
...
if (kvListKeys=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvListKeys', was 'kvListKeys' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}


if (kvListKeysPage=== undefined) {
  const err = new Error("unexpectedly undefined instance import 'kvListKeysPage', was 'kvListKeysPage' available at instantiation?");
  console.error("ERROR:", err.toString());
  throw err;
}

const { clockMs, log, randomBytes } = imports['astrid:sys/host'];
...
_trampoline1.fnName = 'astrid:ipc/host@1.0.0#publish';
...
_trampoline3.fnName = 'astrid:sys/host@1.0.0#randomBytes';

const _trampoline4 = function(arg0, arg1, arg2) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-list-keys"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
switch (variant5.tag) {
  case 'ok': {
    ...
    dataView(memory0).setUint32(arg2 + 4, result2, true);
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-list-keys"][Instruction::Return]', {
  funcName: 'kv-list-keys',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline4.fnName = 'astrid:kv/host@1.0.0#kvListKeys';
...
_trampoline5.fnName = 'astrid:kv/host@1.0.0#kvDelete';
...
_trampoline6.fnName = 'astrid:kv/host@1.0.0#kvGet';
...
const _trampoline7 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  ...
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-list-keys-page"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => kvListKeysPage(result0, variant2, arg5 >>> 0),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
switch (variant10.tag) {
  case 'ok': {
    ...
    var {keys: v3_0, nextCursor: v3_1 } = e;
    var vec5 = v3_0;
    ...
    dataView(memory0).setUint32(arg6 + 8, len5, true);
    dataView(memory0).setUint32(arg6 + 4, result5, true);
    var variant7 = v3_1;
    if (variant7 === null || variant7=== undefined) {
      dataView(memory0).setInt8(arg6 + 12, 0, true);
    } else {
      const e = variant7;
      dataView(memory0).setInt8(arg6 + 12, 1, true);
      
      var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
      var ptr6= encodeRes.ptr;
      var len6 = encodeRes.len;
      
      dataView(memory0).setUint32(arg6 + 20, len6, true);
      dataView(memory0).setUint32(arg6 + 16, ptr6, true);
    }
  ...
  case 'err': {
    ...
    switch (variant9.tag) {
      ...
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant9.tag)}\` (received \`${variant9}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-list-keys-page"][Instruction::Return]', {
  funcName: 'kv-list-keys-page',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline7.fnName = 'astrid:kv/host@1.0.0#kvListKeysPage';

const _trampoline8 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  let variant2;
  ...
  _debugLog('[iface="astrid:kv/host@1.0.0", function="kv-cas"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => kvCas(result0, variant2, result3),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
switch (variant6.tag) {
  ...
  case 'err': {
    ...
    switch (variant5.tag) {
      case 'invalid-key': {
        dataView(memory0).setInt8(arg7 + 4, 0, true);
        break;
      }
      case 'too-large': {
        dataView(memory0).setInt8(arg7 + 4, 1, true);
        break;
      }
      case 'quota': {
        dataView(memory0).setInt8(arg7 + 4, 2, true);
        break;
      }
      case 'cas-mismatch': {
        dataView(memory0).setInt8(arg7 + 4, 3, true);
        break;
      }
      case 'unknown': {
        const e = variant5.val;
        dataView(memory0).setInt8(arg7 + 4, 4, true);
        
        var encodeRes = _utf8AllocateAndEncode(e, realloc0, memory0);
        var ptr4= encodeRes.ptr;
        var len4 = encodeRes.len;
        
        dataView(memory0).setUint32(arg7 + 12, len4, true);
        dataView(memory0).setUint32(arg7 + 8, ptr4, true);
        break;
      }
      default: {
        throw new TypeError(`invalid variant tag value \`${JSON.stringify(variant5.tag)}\` (received \`${variant5}\`) specified for \`ErrorCode\``);
      }
    }
...
_debugLog('[iface="astrid:kv/host@1.0.0", function="kv-cas"][Instruction::Return]', {
  funcName: 'kv-cas',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline8.fnName = 'astrid:kv/host@1.0.0#kvCas';
let exports2;
let postReturn0;
...
null,
{
  ...
  _lowerFlatResult({
    caseMetas: [
    [ 'ok', _lowerFlatRecord({ fieldMetas: [['keys', _lowerFlatList({
      elemLowerFn: _lowerFlatStringAny,
      elemSize32: 8,
      elemAlign32: 4,
    }), 8, 4 ],['nextCursor', 
    ...
    , 12, 4 ],], size32: 20, align32: 4 }), 24, 4, 4 ],
    [ 'err', _lowerFlatVariant({
      caseMetas: [[ 'invalid-key', null, 0, 0, 0 ],[ 'too-large', null, 0, 0, 0 ],[ 'quota', null, 0, 0, 0 ],[ 'cas-mismatch', null, 0, 0, 0 ],[ 'unknown', _lowerFlatStringAny, 8, 4, 2 ],],
      variantSize32: 12,
      variantAlign32: 4,
...
({ exports: exports1 } = yield instantiateCore(yield module0, {
  ...
  'astrid:kv/host@1.0.0': {
    'kv-cas': exports0['7'],
    'kv-delete': exports0['4'],
    'kv-get': exports0['5'],
    'kv-list-keys': exports0['3'],
    'kv-list-keys-page': exports0['6'],
  },
