...
export const GET: APIRoute = ({ site }) => {
  ...
  const lines: string[] = [
    ...
    `Stable AOS release: ${AOS_RELEASE.version}.`,
    `Host plugins: ${AOS_RELEASE.oracles.pluginIdentity} from ${AOS_RELEASE.oracles.marketplace}. The website installer installs AOS first, then offers plugins for supported hosts. Oracle versions are independent of the AOS version.`,
    '',
    '## Site',
    '',
